...
\hl{Write about the MOTIVATION: the current threat of quantum computers to classical cryptography, the need for post-quantum cryptography, etc.}\\
\hl{Problem Statement: Why classical key exchange neeed to evolve} \\
\hl{Objectives: Design and implement an authenticated post-quantum key exchange protocol based on EKE and CRYSTALS-Kyber}\\
...
\section {Proposed Design: PQ-EKE with Kyber}
